        ...
        html.Div([
            ...
            html.Div([
                ...
                html.Div([
                    ...
                    html.Div([
                        html.Div([
                            html.Div("All",      id="props-filter-all",  n_clicks=0, className="tab active"),
                            ...
                            html.Div("3-Ptrs",   id="props-filter-3pm",  n_clicks=0, className="tab"),
                            ...
                            html.Div("Dbl-Dbl",  id="props-filter-dd",   n_clicks=0, className="tab"),
                            html.Div("Tri-Dbl",  id="props-filter-td",   n_clicks=0, className="tab"),
                        ], className="tab-group"),
